...
public class GlassdoorSentimentAnalysis {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Add the positive and negative words file to distributed cache
        job.addCacheFile(new URI("hdfs://localhost:9000/user/shaunv/project/Positive_and_Negative_Word_List.csv"));
        ...
        ChainMapper.addMapper(job, SentimentMapper.class, LongWritable.class, Text.class, Text.class, IntWritable.class, sentimentConf);

        job.setMapperClass(ChainMapper.class);
        job.setMapOutputKeyClass(Text.class); // set the map output key class to Text
